...
To comply with the strict computational complexity requirement of \(\mathcal{O}(N)\) over massive financial arrays (avoiding any imperative \texttt{for} or \texttt{while} loops), the core of the \texttt{Portfolio} is designed as a purely mathematical conduit. Figure \ref{fig:activity_diagram} details this pipeline.
